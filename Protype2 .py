...
def concat_vertical_resize(hat_presented,tshirt_presented, resample=Image.BICUBIC, resize_big_image=True):
    ...
    if hat_presented.width == tshirt_presented.width:
        ...
        _hat_presented = hat_presented.resize((tshirt_presented.width, int(hat_presented.height * tshirt_presented.width / hat_presented.width)), resample=resample)
        _tshirt_presented = tshirt_presented

        
    else:
        _hat_presented = hat_presented
        _tshirt_presented = tshirt_presented.resize((hat_presented.width, int(tshirt_presented.height * hat_presented.width / tshirt_presented.width)), resample=resample)
    dst = Image.new('RGB', (_hat_presented.width, _hat_presented.height + _tshirt_presented.height))
    dst.paste(_hat_presented, (0, 0))
    dst.paste(_tshirt_presented, (0, _hat_presented.height))
    return dst


concat_vertical_resize(hat_presented, tshirt_presented, resize_big_image=False).save('The_outfit.jpg')
...
get_concat_v_multi_resize([hat_presented, tshirt_presented, jeans_presented, shoes_presented,]).save('The_outfit_V2.jpg')
